...
<div class="container">
  <div class="row justify-content-center mt-4">
    <div class="col-md-8 col-xl-6">
      <div class="card mt-5">
        <div class="card-header d-block text-center" style="padding: 75px; background-image: url({{ asset('img/app/' . mySetting()->image_bg_app) }}); background-size: contain;background-repeat: no-repeat;">
              ...
              <div class="col-12">
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    value="{{ old('email') }}"
                    type="email"
                    placeholder="e.g: yourname@unpad.ac.id"
                    required>
                  @error('email')
                  <small class="text-danger"> {{ $message }} </small>
                  @enderror
