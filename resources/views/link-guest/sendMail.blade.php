                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" width="33.33%" height="10" data-bgcolor="1st Color"
                                                    bgcolor="#006932" style="width:33.33%;"></td>
                                                ...
                                                <td align="center" width="33.33%" height="10" data-bgcolor="3rd Color"
                                                    bgcolor="#ffc442" style="width:33.33%;"></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr data-element="freya-logo" data-label="Logo">
                                    <td align="center">
                                        <table data-inner-table border="0" align="center" cellpadding="0"
                                            ...
                                            role="presentation" width="250" style="width:250px;max-width:250px;">
                                            <tr>

                                                <td align="center" class="img-responsive">
                                                    <img src="cid:logo_aplikasi" alt="logo" width="250">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                        ...
                                                        <tr>
                                                            <td class="rwd-col" align="center">
                                                                ...
                                                                <table border="0" align="left" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left">
                                                                            <img style="width: 50px; border: 0px; display: inline !important; border-radius: 50%;background-color: #b9dd26;"
                                                                                src="cid:favicon"
                                                                                width="50" border="0" editable="true"
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr data-element="freya-invitation-message-paragraph"
                                                            ...
                                                            <td data-text-style="Paragraphs" align="left"
                                                                ...
                                                                <singleline>
                                                                    <div mc:edit data-text-edit style="text-align: justify;">
                                                                        Kepada Yth. <strong>{{ ($invt->kehadiran_guest == 'Diwakilkan' && !empty($invt->namawakil_guest) ? $invt->namawakil_guest : $invt->name_guest) }}</strong>,
                                                                        <br><br>
                                                                        Selamat! Anda telah mendaftar pada kegiatan <strong
                                                                            style="color: #006931;">{!! nl2br($event->name_event) !!}</strong>
                                                                        <br><br>

                                                                        Berikut ini adalah detail acara:
                                                                        <br>
                                                                        <li>
                                                                            <strong>Acara</strong> : {!! nl2br($event->name_event) !!}
                                                                        </li>
                                                                        <li><strong>Tanggal</strong> : {{ \Carbon\Carbon::parse($event->start_event)->translatedFormat('d F Y') }}</li>
                                                                        <li><strong>Waktu</strong> : {{ \Carbon\Carbon::parse($event->start_event)->isoFormat('HH:mm') }} - {{ \Carbon\Carbon::parse($event->end_event)->isoFormat('HH:mm') }} WIB</li>

                                                                        <li>
                                                                            <strong>Lokasi</strong> : <b>{{ $event->place_event }}</b>, {{ $event->location_event }}
                                                                        </li>
                                                                        <br>
                                                                        Berikut data informasi Anda:

                                                                        <li>
                                                                            <strong>Nama</strong> : {{ ($invt->kehadiran_guest == 'Diwakilkan' && !empty($invt->namawakil_guest) ? $invt->namawakil_guest : $invt->name_guest) }}
                                                                        </li>

                                                                        <li>
                                                                            <strong>Fakultas</strong> : {{ $invt->faculty_guest }}
                                                                        </li>

                                                                        <li>
                                                                            <strong>NIM </strong> : {{ $invt->nim_guest }}
                                                                        </li>
                                                                        <li>
                                                                            <strong>Email</strong> : {{ $invt->email_guest }}
                                                                        </li>
                                                                        <li>
                                                                            <strong>Handphone</strong> : {{ $invt->phone_guest }}
                                                                        </li>
                                                                        ...
                                                                        <div style="text-align: center;">
                                                                            <img style="width:250px;border:0px;display: inline!important; "
                                                                                ...
                                                                                data-label="Avatar" alt="Avatar">
                                                                            <br>
                                                                            <strong>Kode QR Anda : {{ @$invt->qrcode_invitation }}</strong>
                                                                        </div>
                                                                        <br>
                                                                        <div style="text-align: center;">
                                                                            atau akses Kode QR Anda melalui tautan berikut: <br> <a href="{{ url('/invitation/' . @$invt->qrcode_invitation) }}" target="_blank" style="display: inline-block; color: #212529; text-align: center; vertical-align: middle; user-select: none; background-color: transparent; border: 1px solid transparent; padding: 0.375rem 0.75rem; border-radius: 0.25rem; color: #212529; background-color: #ffc107; border-color: #ffc107; text-decoration: none; border-radius: 50rem; margin-bottom: 1rem; margin-top: 1rem;">Klik di sini untuk melihat Kode QR</a></p>
                                                                        </div>
                                                                        <br>
                                                                        <br>
                                                                        <strong>Catatan:</strong> <br>
                                                                        <li>Mohon tunjukkan Kode QR dalam bentuk digital kepada petugas registrasi.</li>
                                                                        <li>Penukaran ID Card hanya dapat dilakukan dengan menunjukkan Kode QR.</li>
                                                                        <li>Registrasi ulang dibuka mulai pukul <strong>{{ \Carbon\Carbon::parse($event->start_event)->isoFormat('HH:mm') }} WIB</strong>, dan peserta diharapkan hadir tepat waktu.</li>
                                                                        <li>ID Card mohon digunakan selama acara berlangsung</li>
                                                                        <br><br>

                                                                        Terima kasih telah menjadi bagian dari acara
                                                                        ini. Kami menantikan kehadiran anda.
                                                                        <br><br>
                                                                        <strong>Salam Hormat,</strong> <br>

                                                                        <strong style="color: #006931;">Panitia
                                                                            acara</strong>
                                                                    </div>
                                                                </singleline>
                                                            </td>
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr data-element="freya-footer-paragraph" data-label="Paragraphs">
                                                <td data-text-style="Paragraphs" align="left" class="center-text"
                                                    ...
                                                    <singleline>
                                                        <div mc:edit data-text-edit>
                                                            2025 {{ mysetting()->author_app }} Inc. All Rights Reserved. <br>
                                                        </div>
                                                    </singleline>
                                                </td>
                                            </tr>
                            ...
                            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr data-element="freya-footer-permission-reminder" data-label="Permission reminder">
                                    <td data-text-style="Paragraphs" align="left" class="center-text"
                                        ...
                                        <singleline>
                                            <div mc:edit data-text-edit>
                                                Anda menerima email ini dari {{ mysetting()->author_app }} ketika Anda mendaftarkan
                                                {{ $event->name_event }}.
                                            </div>
                                        </singleline>
                                    </td>
